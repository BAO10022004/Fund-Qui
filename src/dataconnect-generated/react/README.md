...
```javascript
useCreateMood(options?: useDataConnectMutationOptions<CreateMoodData, FirebaseError, void>): UseDataConnectMutationResult<CreateMoodData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateMood(dc: DataConnect, options?: useDataConnectMutationOptions<CreateMoodData, FirebaseError, void>): UseDataConnectMutationResult<CreateMoodData, undefined>;
```
...
export default function CreateJournalEntryComponent() {
  ...
  mutation.mutate({ title: ..., content: ..., entryDate: ..., });
