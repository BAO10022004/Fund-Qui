...
```ts
import { useCreateMood, useListJournalEntries, useCreateJournalEntry, useGetUser } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateMood();

const { data, isPending, isSuccess, isError, error } = useListJournalEntries();
...
```js
import { createMood, listJournalEntries, createJournalEntry, getUser } from '@dataconnect/generated';


// Operation CreateMood: 
